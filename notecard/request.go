...
// A Note on Time
// The Notecard protocol communicates the Time value as a uint32. However, this is non-standard and problematic for Notehub which would have to
// constantly cast it to the modern Unix standard of int64 (i.e., the time_t type in Posix C libraries.)
// In older OSes, Unix time (time_t) was int32. It was never defined as a uint32.
// Thus by converting the uint32 to int64, it may allow us to delay the 2038 problem to 2106.
